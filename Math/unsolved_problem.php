...
<html>
	...
	<?php
	  ...
	  // echo $search;
	   $problem_per_page=10;
	   $sql="SELECT problem.prob_id, problem.prob_heading, problem.prob_pic FROM problem, solution WHERE problem.prob_id = solution.solution_id ";
...
while($row = mysqli_fetch_array($run_query)) {
    ...
    echo "&nbsp;";
    echo '<p style="font-size:28px;margin-bottom:1px;padding:1px;"> <b>' . $row['prob_heading'] . '</p> </b> <br>';
